...
var BridgeUtil = /** @class */ (function () {
    ...
    BridgeUtil.prototype.getProof_ = function (networkId, depositCount) {
        return _services__WEBPACK_IMPORTED_MODULE_0__["service"].hermezNetwork.getMerkleProofForHermez(networkId, depositCount).then(function (proof) {
            return proof;
        }).catch(function (_) {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ "./src/utils/index.ts");
/* harmony import */ var _hermez_token__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hermez_token */ "./src/hermez/hermez_token.ts");
...
var ERC20 = /** @class */ (function (_super) {
    ...
    ERC20.prototype.deposit = function (amount, userAddress, option) {
        ...
        return this.childBridge.networkID().then(function (networkId) {
            return _this.parentBridge.bridgeAsset(_this.contractParam.address, networkId, userAddress, amountInABI, permitData, option);
        });
    };
    /**
    ...
    ERC20.prototype.withdraw = function (amount, userAddress, option) {
        ...
        return this.parentBridge.networkID().then(function (networkId) {
            return _this.childBridge.bridgeAsset(_this.contractParam.address, networkId, userAddress, amountInABI, permitData, option);
        });
    };
    /**
        ...
        switch (permitType) {
            case ___WEBPACK_IMPORTED_MODULE_3__["Permit"].DAI:
                ...
                typedData.message = {
                    ...
                    nonce: nonce,
                    expiry: ___WEBPACK_IMPORTED_MODULE_3__["MAX_AMOUNT"],
                    allowed: true,
                };
            ...
            case ___WEBPACK_IMPORTED_MODULE_3__["Permit"].UNISWAP:
                ...
                typedData.message = {
                    ...
                    value: amount,
                    nonce: nonce,
                    deadline: ___WEBPACK_IMPORTED_MODULE_3__["MAX_AMOUNT"],
                };
        }
        return typedData;
    };
    ...
    ERC20.prototype.encodePermitFunctionData_ = function (contract, permitType, signatureParams, spenderAddress, account, nonce, amount) {
        ...
        switch (permitType) {
            case ___WEBPACK_IMPORTED_MODULE_3__["Permit"].DAI:
                method = contract.method("permit", account, spenderAddress, nonce, ___WEBPACK_IMPORTED_MODULE_3__["MAX_AMOUNT"], true, v, r, s);
                break;
            case ___WEBPACK_IMPORTED_MODULE_3__["Permit"].EIP_2612:
            case ___WEBPACK_IMPORTED_MODULE_3__["Permit"].UNISWAP:
                method = contract.method("permit", account, spenderAddress, amount, ___WEBPACK_IMPORTED_MODULE_3__["MAX_AMOUNT"], v, r, s);
                break;
        }
    ...
    return ERC20;
}(_hermez_token__WEBPACK_IMPORTED_MODULE_2__["HermezToken"]));



/***/ }),

/***/ "./src/hermez/hermez_bridge.ts":
/*!*************************************!*\
  !*** ./src/hermez/hermez_bridge.ts ***!
  \*************************************/
/*! exports provided: HermezBridge */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HermezBridge", function() { return HermezBridge; });
...
var HermezBridge = /** @class */ (function (_super) {
    __extends(HermezBridge, _super);
    function HermezBridge(client_, address, isParent) {
        return _super.call(this, {
            address: address,
    ...
    HermezBridge.prototype.method = function (methodName) {
        var args = [];
     ...
     */
    HermezBridge.prototype.bridgeAsset = function (token, destinationNetwork, destinationAddress, amount, permitData, option) {
        var _this = this;
        if (permitData === void 0) { permitData = '0x'; }
        return this.method("bridgeAsset", token, destinationNetwork, destinationAddress, _utils__WEBPACK_IMPORTED_MODULE_0__["Converter"].toHex(amount), permitData).then(function (method) {
            return _this.processWrite(method, option);
        });
    };
    /**
     ...
     * @memberof HermezBridge
     */
    HermezBridge.prototype.claimAsset = function (smtProof, index, mainnetExitRoot, rollupExitRoot, originNetwork, originTokenAddress, destinationNetwork, destinationAddress, amount, metadata, option) {
        var _this = this;
     ...
     * @memberof HermezBridge
     */
    HermezBridge.prototype.getMappedTokenInfo = function (originNetwork, originTokenAddress) {
        var _this = this;
     ...
     * @memberof HermezBridge
     */
    HermezBridge.prototype.isClaimed = function (index) {
        var _this = this;
     ...
     * @memberof HermezBridge
     */
    HermezBridge.prototype.precalculatedMappedTokenInfo = function (originNetwork, originTokenAddress) {
        var _this = this;
     ...
     * @memberof HermezBridge
     */
    HermezBridge.prototype.getOriginTokenInfo = function (wrappedToken) {
        var _this = this;
     ...
     * @memberof HermezBridge
     */
    HermezBridge.prototype.networkID = function () {
        var _this = this;
        if (this.networkID_) {
...
/***/ "./src/hermez/hermez_token.ts":
/*!************************************!*\
  !*** ./src/hermez/hermez_token.ts ***!
  \************************************/
/*! exports provided: HermezToken */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HermezToken", function() { return HermezToken; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils/index.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var HermezToken = /** @class */ (function (_super) {
    __extends(HermezToken, _super);
    function HermezToken(contractParam, client, getHermezContracts) {
        var _this = _super.call(this, contractParam, client) || this;
        _this.getHermezContracts = getHermezContracts;
        return _this;
    }
    Object.defineProperty(HermezToken.prototype, "parentBridge", {
        get: function () {
    ...
    Object.defineProperty(HermezToken.prototype, "childBridge", {
        get: function () {
    ...
    Object.defineProperty(HermezToken.prototype, "bridgeUtil", {
        get: function () {
...
/*!*****************************!*\
  !*** ./src/hermez/index.ts ***!
  \*****************************/
/*! exports provided: HermezBridge, BridgeUtil, HermezClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HermezClient", function() { return HermezClient; });
/* harmony import */ var _erc20__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./erc20 */ "./src/hermez/erc20.ts");
/* harmony import */ var _hermez_bridge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hermez_bridge */ "./src/hermez/hermez_bridge.ts");
/* harmony import */ var _bridge_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bridge_util */ "./src/hermez/bridge_util.ts");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HermezBridge", function() { return _hermez_bridge__WEBPACK_IMPORTED_MODULE_1__["HermezBridge"]; });
...
var HermezClient = /** @class */ (function (_super) {
    __extends(HermezClient, _super);
    function HermezClient() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HermezClient.prototype.init = function (config) {
        var _this = this;
        var client = this.client;
        return client.init(config).then(function (_) {
            var mainHermezContracts = client.mainHermezContracts;
            var hermezContracts = client.hermezContracts;
            ...
            _this.rootChainBridge = new _hermez_bridge__WEBPACK_IMPORTED_MODULE_1__["HermezBridge"](_this.client, config.parentBridge, true);
            _this.childChainBridge = new _hermez_bridge__WEBPACK_IMPORTED_MODULE_1__["HermezBridge"](_this.client, config.childBridge, false);
            _this.bridgeUtil = new _bridge_util__WEBPACK_IMPORTED_MODULE_2__["BridgeUtil"](_this.client);
            if (!_services__WEBPACK_IMPORTED_MODULE_5__["service"].hermezNetwork) {
                if (_config__WEBPACK_IMPORTED_MODULE_4__["config"].hermezBridgeService[_config__WEBPACK_IMPORTED_MODULE_4__["config"].hermezBridgeService.length - 1] !== '/') {
                    _config__WEBPACK_IMPORTED_MODULE_4__["config"].hermezBridgeService += '/';
                }
                _services__WEBPACK_IMPORTED_MODULE_5__["service"].hermezNetwork = new _services__WEBPACK_IMPORTED_MODULE_5__["NetworkService"](_config__WEBPACK_IMPORTED_MODULE_4__["config"].hermezBridgeService);
            }
            return _this;
        });
    };
    ...
    return HermezClient;
}(_utils__WEBPACK_IMPORTED_MODULE_3__["HermezBridgeClient"]));
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: use, eventBusPromise, EventBus, Logger, merge, mapPromise, ProofUtil, HttpRequest, Converter, Web3SideChainClient, BaseToken, setProofApi, setHermezProofApi, resolve, promiseResolve, promiseAny, BridgeClient, ABIManager, throwNotImplemented, HermezBridgeClient, utils, Log_Event_Signature, ERROR_TYPE, ExitUtil, RootChainManager, RootChain, POSClient, MAX_AMOUNT, ADDRESS_ZERO, DAI_PERMIT_TYPEHASH, EIP_2612_PERMIT_TYPEHASH, EIP_2612_DOMAIN_TYPEHASH, UNISWAP_DOMAIN_TYPEHASH, Permit, BaseContractMethod, BaseWeb3Client, BaseContract, BaseBigNumber, NetworkService, service, HermezBridge, BridgeUtil, HermezClient, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setHermezProofApi", function() { return _utils__WEBPACK_IMPORTED_MODULE_1__["setHermezProofApi"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HermezBridgeClient", function() { return _utils__WEBPACK_IMPORTED_MODULE_1__["HermezBridgeClient"]; });
...
/* harmony import */ var _hermez__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./hermez */ "./src/hermez/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HermezBridge", function() { return _hermez__WEBPACK_IMPORTED_MODULE_9__["HermezBridge"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BridgeUtil", function() { return _hermez__WEBPACK_IMPORTED_MODULE_9__["BridgeUtil"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HermezClient", function() { return _hermez__WEBPACK_IMPORTED_MODULE_9__["HermezClient"]; });
...
/***/ "./src/interfaces/hermez_client_config.ts":
/*!************************************************!*\
  !*** ./src/interfaces/hermez_client_config.ts ***!
  \************************************************/
/*! no exports provided */
...
/***/ "./src/interfaces/hermez_contracts.ts":
/*!********************************************!*\
  !*** ./src/interfaces/hermez_contracts.ts ***!
  \********************************************/
/*! no exports provided */
...
/* empty/unused harmony star reexport *//* harmony import */ var _hermez_client_config__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./hermez_client_config */ "./src/interfaces/hermez_client_config.ts");
/* empty/unused harmony star reexport *//* harmony import */ var _hermez_contracts__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./hermez_contracts */ "./src/interfaces/hermez_contracts.ts");
...
var NetworkService = /** @class */ (function () {
    ...
    NetworkService.prototype.getMerkleProofForHermez = function (networkID, depositCount) {
        var url = "merkle-proof?net_id=".concat(networkID, "&deposit_cnt=").concat(depositCount);
        return this.httpRequest.get(url).then(function (result) {
            return result.proof;
        });
    };
    NetworkService.prototype.getBridgeTransactionDetails = function (networkID, depositCount) {
        var url = "bridge?net_id=".concat(networkID, "&deposit_cnt=").concat(depositCount);
        return this.httpRequest.get(url).then(function (result) {
...
/***/ "./src/utils/hermez_bridge_client.ts":
/*!*******************************************!*\
  !*** ./src/utils/hermez_bridge_client.ts ***!
  \*******************************************/
/*! exports provided: HermezBridgeClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HermezBridgeClient", function() { return HermezBridgeClient; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils/index.ts");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services */ "./src/services/index.ts");


var HermezBridgeClient = /** @class */ (function () {
    function HermezBridgeClient() {
        this.client = new _utils__WEBPACK_IMPORTED_MODULE_0__["Web3SideChainClient"]();
    }
    /**
     ...
     */
    HermezBridgeClient.prototype.isDepositClaimable = function (txHash) {
        return Promise.all([this.rootChainBridge.networkID(), this.bridgeUtil.getBridgeLogData(txHash, true)]).then(function (result) {
            return _services__WEBPACK_IMPORTED_MODULE_1__["service"].hermezNetwork.getBridgeTransactionDetails(result[0], result[1].depositCount);
     ...
     * @memberof HermezBridgeClient
     */
    HermezBridgeClient.prototype.isWithdrawExitable = function (txHash) {
     ...
     * @memberof HermezBridgeClient
     */
    HermezBridgeClient.prototype.isDeposited = function (txHash) {
        var _this = this;
     ...
     * @memberof HermezBridgeClient
     */
    HermezBridgeClient.prototype.isExited = function (txHash) {
        var _this = this;
...
/*!****************************!*\
  !*** ./src/utils/index.ts ***!
  \****************************/
/*! exports provided: use, eventBusPromise, EventBus, Logger, merge, mapPromise, ProofUtil, HttpRequest, Converter, Web3SideChainClient, BaseToken, setProofApi, setHermezProofApi, resolve, promiseResolve, promiseAny, BridgeClient, ABIManager, throwNotImplemented, HermezBridgeClient, utils */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setHermezProofApi", function() { return _set_proof_api_url__WEBPACK_IMPORTED_MODULE_12__["setHermezProofApi"]; });
...
/* harmony import */ var _hermez_bridge_client__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./hermez_bridge_client */ "./src/utils/hermez_bridge_client.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HermezBridgeClient", function() { return _hermez_bridge_client__WEBPACK_IMPORTED_MODULE_18__["HermezBridgeClient"]; });
...
/*!****************************************!*\
  !*** ./src/utils/set_proof_api_url.ts ***!
  \****************************************/
/*! exports provided: setProofApi, setHermezProofApi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setProofApi", function() { return setProofApi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setHermezProofApi", function() { return setHermezProofApi; });
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services */ "./src/services/index.ts");
...
var setHermezProofApi = function (url) {
    var urlLength = url.length;
    if (url[urlLength - 1] !== '/') {
        url += '/';
    }
    _services__WEBPACK_IMPORTED_MODULE_0__["service"].hermezNetwork = new _services__WEBPACK_IMPORTED_MODULE_0__["NetworkService"](url);
};
...
var Web3SideChainClient = /** @class */ (function () {
    ...
    Object.defineProperty(Web3SideChainClient.prototype, "mainHermezContracts", {
        get: function () {
            return this.getConfig("Main.Contracts");
        },
        enumerable: false,
    ...
    Object.defineProperty(Web3SideChainClient.prototype, "hermezContracts", {
        get: function () {
