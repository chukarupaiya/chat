...
export declare class Erc20Transfer implements MoralisDataObject {
    ...
    toJSON(): {
        ...
        blockTimestamp: import("@moralisweb3/common-core").DateInput;
        blockHash: string;
     ...
     */
    get blockNumber(): import("@moralisweb3/common-core").BigNumberish;
    /**
     * @returns the block timestamp of the tranfer
     * @example transfer.blockTimestamp // Date
     */
    get blockTimestamp(): import("@moralisweb3/common-core").DateInput;
    /**
