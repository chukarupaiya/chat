...
import { EvmSimpleBlockish } from './EvmSimpleBlock';
...
export declare class EvmBlock implements MoralisDataObject {
     ...
     */
    static create(data: EvmBlockish, core?: Core): EvmBlock;
    private _data;
    ...
    toJSON(): {
        ...
        transactions: {
            ...
            signature: import("@moralisweb3/common-core").MoralisDataObjectValue | undefined; /**
