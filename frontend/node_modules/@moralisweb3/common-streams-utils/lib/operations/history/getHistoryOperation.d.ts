import { Camelize, PaginatedOperation } from '@moralisweb3/common-core';
...
export declare const getHistoryOperation: PaginatedOperation<GetHistoryRequest, GetHistoryJSONRequest, GetHistoryResponse, GetHistoryJSONResponse['result']>;
declare function deserializeResponse(jsonResponse: GetHistoryJSONResponse): {
    id: string;
    date: string;
    payload?: (Partial<{
        block: {
...
declare function serializeRequest(request: GetHistoryRequest): GetHistoryRequest;
export {};
//# sourceMappingURL=getHistoryOperation.d.ts.map